...
public final class Escape implements LifeListener, RenderListener, EventListener {
	...
	private void createScreen() {
		...
		jupiter = new AbstractStage(this) {
			private final Stage stage = new GameStage(engine, getWorld(), getEntityContainer(), ScenarioLoader.JUPITER, getShipFactory(), 40, 0, true);
		...
		moon = new AbstractStage(this) {
			private final Stage stage = new GameStage(engine, getWorld(), getEntityContainer(), ScenarioLoader.MOON, getShipFactory(), 55, 1, true);
		...
		earth = new AbstractStage(this) {
			private final Stage stage = new GameStage(engine, getWorld(), getEntityContainer(), ScenarioLoader.EARTH, getShipFactory(), 52, 2, true);
